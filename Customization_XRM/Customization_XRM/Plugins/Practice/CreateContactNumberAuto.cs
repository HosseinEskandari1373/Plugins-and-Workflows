...
{
    public class CreateContactNumberAuto : PluginBase
    {
        public CreateContactNumberAuto() : base(typeof(CreateContactNumberAuto))
        {
                        ...
                        context.InputParameters["Target"] is Entity)
                {
                    ...
                    if (entity.LogicalName == contact.LogicalName)
                    {
                        if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity)
                        {
                            ...
                            {
                                var newCounter = Convert.ToInt32("1").ToString().PadLeft(5, '0');
                            ...
                            else
                            {
                                ...
                                var lencurrentrecordcounternumber = currentrecordcounternumber.Length - 5;
                                var currentrecordcounternumbers = currentrecordcounternumber.Substring(lencurrentrecordcounternumber, 5);
